...
INSERT INTO products (id, name, description, price, unit, stock, category_id, origin_state, freshness_score, is_organic, image_url) VALUES
  ...
  (2,  'Sona Masuri Rice',        'Lightweight and aromatic medium-grain rice. Sourced from the Tungabhadra river belt.',         62.00, 'kg',  350, 1, 'Andhra Pradesh',92, FALSE, 'sona_masuri_rice_premium_1776935810610.png'),
  ...
  (4,  'Toor Dal (Premium)',      'Unpolished Pigeon Peas. High protein content with no artificial colouring.',                    115.00,'kg',  300, 2, 'Maharashtra',  94, FALSE, 'toor_dal_unpolished_1776935827005.png'),
  (5,  'Moong Dal (Yellow)',      'Easily digestible split yellow lentils. Pesticide-free farming.',                               105.00,'kg',  250, 2, 'Rajasthan',    95, TRUE,  'moong_dal_yellow_1776935621533.png'),
  (6,  'Urad Dal (Split)',        'Essential for creamy dals and batters. Sourced from Madhya Pradesh.',                           120.00,'kg',  200, 2, 'Madhya Pradesh',88, FALSE, 'urad_dal_split_premium_1776935928107.png'),
  (7,  'Ragi (Finger Millet)',    'Calcium-rich supergrain. Essential for bone health.',                                           68.00, 'kg',  180, 3, 'Karnataka',    97, TRUE,  'ragi.png'),
  (8,  'Kodo Millet',             'Ancient gluten-free grain. High in dietary fiber and minerals.',                                85.00, 'kg',  150, 3, 'Tamil Nadu',   94, TRUE,  'kodo_millet_premium_1776935944109.png'),
  (9,  'Whole Wheat (Sharbati)',  'Premium Sharbati wheat from Sehore. Makes the softest chapatis.',                               44.00, 'kg',  600, 4, 'Madhya Pradesh',91, FALSE, 'sharbati_wheat_grains_1776935847537.png'),
  (10, 'Cold-Pressed Mustard Oil','Traditionally extracted using wooden Ghani. Pure and pungent.',                                195.00,'litre',150, 5, 'Haryana',      89, TRUE,  'mustard_oil_pure_1776935701451.png'),
  (11, 'Red Rajma (Kashmiri)',    'Small, dark red kidney beans from the high altitudes of Jammu & Kashmir.',                    160.00,'kg',  100, 2, 'J&K',          93, TRUE,  'red_rajma_premium_1776935963522.png'),
  (12, 'Kabuli Chana (Large)',    'Extra-large chickpeas for the perfect Chole. Sourced from the Malwa region.',                 130.00,'kg',  280, 2, 'Madhya Pradesh',90, FALSE, 'kabuli_chana_raw_1776935683751.png'),
  (13, 'Black Pepper (Wayanad)',  'King of Spices. Bold, high-piperine pepper from the Wayanad hill tracts.',                    750.00,'kg',   50, 6, 'Kerala',       99, TRUE,  'black_pepper_whole_1776935641046.png'),
  (14, 'Turmeric (Lakadong)',     'World-renowned turmeric with 7-12% curcumin content.',                                          350.00,'kg',   80, 6, 'Meghalaya',    98, TRUE,  'turmeric_powder_premium_1776935863438.png'),
  (15, 'Saffron (Kashmiri)',      'Authentic Grade A++ Lacha Saffron from Pampore. Hand-harvested.',                               450.00,'gm',   20, 6, 'Jammu & Kashmir',99, TRUE,  'kashmiri_saffron_premium_1776935907730.png'),
  (16, 'Desi Ghee (A2)',          'Traditional Bilona method A2 cow ghee. Sourced from Gir cows.',                                 950.00,'lt',  100, 5, 'Gujarat',       94, TRUE,  'desi_ghee_a2_1776935576015.png'),
  (17, 'Green Cardamom (Bold)',   'Extra bold 8mm cardamom from Idukki. Intense aroma.',                                           2200.00,'kg',  40, 6, 'Kerala',        97, TRUE,  'green_cardamom_pods_1776935774130.png'),
  ...
  (22, 'Jowar (Sorghum)',         'Gluten-free sorghum millet. Light on stomach.',                                                 60.00, 'kg',  190, 3, 'Maharashtra',  88, TRUE,  'jowar_millet_whole_1776935755675.png'),
